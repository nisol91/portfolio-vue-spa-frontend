export const messages = {
    en: {
        message: {
            home1: 'welcome to nsz development studio',
            home2: 'hand crafting of digital ideas',
            projects: 'check out the projects',
    ...
    it: {
        message: {
            home1: 'nsz development studio',
            home2: 'artigianato per idee digitali',
